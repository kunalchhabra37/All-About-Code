...
public class Solution {
    ...
    public static void pairSum(BinaryTreeNode<Integer> current,int sum,BinaryTreeNode<Integer> root){
        if(current==null)
           return;
        ...
        pairSum(current.left,sum,root);
        pairSum(current.right,sum,root);          
